...
package Kernel::System::Customer::AuthModule::SAML2SP;
...
#use FindBin qw($Bin);
#use lib "$Bin/../";
use Kernel::System::Customer::AuthModule::SAML2SP::Config;
use Kernel::System::Customer::AuthModule::SAML2SP::AuthRequest;
use Kernel::System::Customer::AuthModule::SAML2SP::Response;
